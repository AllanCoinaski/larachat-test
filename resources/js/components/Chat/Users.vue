...
export default {
  ...
  computed: {
    ...
    users () {//filtro de usuarios, usa o include q seria uma parte
  ...
  methods: {
    ...
    openChatWithUser (user) {//abre conversa do usuario
        this.activeChat = user.id

        this.addUserChat(user)

        this.getMessagesConversation()//busca as mensagens, se quiser posso fazer um catch aq
    }
  },
};
</script>
