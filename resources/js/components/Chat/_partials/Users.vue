...
export default {
  mounted(){// assim que o componente é montado, consigo passar uma action
    this.getUsers()
  },
  computed:{//propriedade computada para acessar os state e consequentemente os usuarios listados
  ...mapGetters({
  ...
  methods:{
    ...mapActions(['getUsers'])///chamao getUsers dos actions.js
  }
};
</script>
